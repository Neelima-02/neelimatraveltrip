...
const Header = props => {
  ...
  return (
    <header className="navbar-container">
      <nav className="lg-header-container-view">
        <h1 className="lg-header-heading-view">
          <Link className="link-item-view" to="/">
            Travel Trip
          </Link>
        </h1>

        <div className="lg-nav-list-view">
          <div className="lg-nav-item1">
          ...
          <div className="sm-btn-container-view">
            <button
